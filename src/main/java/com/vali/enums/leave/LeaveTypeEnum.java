...
public enum LeaveTypeEnum {
    ...
    PreMaternityLeavePayDeduction(2, "产前假",
                                  "中国政府规定在孩子未满 1周岁之前,女性员工每天享有 1小时的哺乳假。对于家在公司的刚生育完孩子的女性可按规定享有次假。但由于很少有员工住在公司附近能享有此假,公司决定给予凡无法享有此假的女性员工额外 5天的产假来替代此哺乳假。 \n"
                                  + "\n"
                                  + "China’s employment regulations provide for female employees to take one hour’s lactation leave each day until the child is 1 year old. Female employees who have given birth to a child, and who live close enough to their work can claim this entitlement. But since very few Rolls-Royce employees do live close enough to work to make this feasible, Rolls-Royce offers female employees an additional five days maternity leave instead of lactation leave.\n"
                                  + "\n"
    ...
    MaternityLeave(3, "产假", "单胎顺产者,产假90天,其中产前15天,产后75天;\n"
                            + "\n"
    ...
    PregnancyCheckUpsLeave(4, "孕期检查假", "本公司遵守怀孕检查的法定要求对于上述检查预约,您有权享有带薪休假,但需提供相关证明。您应将您的怀孕检查计划提前通知您的直线经理\n"
                                       + "\n"
    ...
    SickLeave(5, "带薪病假", "每年您有权享受为期 10天的带薪病假。带薪病假天数不能结转至下一年。\n"
                         + "\n"
    ...
    MarriageLeave(6, "婚假", "您首次合法结婚可按国家规定享受3天婚假,晚婚的员工可增加晚婚假7天,晚婚假应当与婚假合并连续使用,遇法定节假日顺延。(女性年满23周岁,男性年满25周岁初婚的为晚婚)。\n"
                           + "\n"
    ...
    PaternityLeave(7, "看护假", "所有父亲在有第一个孩子时都有权享有看护假。看护假为期 3天。\n"
    ...
    CompassionateLeave(10, "丧假", "如果您的直系亲属(父母、配偶、孩子)去世,您可享有 3天有薪假期。\n"
    ...
    NoPaidLeaveNoPay(11, "无薪事假", "在特殊情况下,员工可以申请无薪事假,但需经其直接经理批准。其直接经理有权决定是否批准无薪事假。无薪事假的申请应视具体情况而定。\n"
                                 + "\n"
    ...
    MiscarriageLeave(12, "自然流产假", "上海:妊娠3个月内自然流产或子宫外孕者,给予产假30天;妊娠3个月以上,7个月以下自然流产者,给予产假45天。您需要提供医生/医院开具的流产证明。\n"
                                  + "\n"
